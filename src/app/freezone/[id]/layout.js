...
export async function generateMetadata({ params }) {
  ...
  try {
    ...
    return {
      ...
      alternates: {
        canonical: meta.canonical || `https://adlbusinesssolutions.com/freezone/${id}`,
      },
      openGraph: {
        title: meta.title,
        description: meta.description,
        url: meta.canonical || `https://adlbusinesssolutions.com/freezone/${id}`,
    ...
    return {
      ...
      ...safeDetails,
      alternates: {
        canonical: `https://adlbusinesssolutions.com/freezone/${id}`,
      },
      openGraph: {
        title: safeDetails.title,
        description: safeDetails.description,
        url: `https://adlbusinesssolutions.com/freezone/${id}`,
        siteName: "ADL Business Solutions",
        images: [
          {
            url: "/assets/images/about/modern-infrastructure.png",
